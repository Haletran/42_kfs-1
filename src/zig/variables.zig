...
// Scrollback buffer to preserve text history
pub const SCROLLBACK_SIZE = 1000; // Total lines to keep in history
pub var scrollback_buffer: [SCROLLBACK_SIZE * VGA_WIDTH]u16 = undefined;
pub var scrollback_position: usize = 0; // Current position in scrollback buffer
pub var scroll_offset: usize = 0; // How many lines we've scrolled up from the bottom
pub var saved_screen: [VGA_HEIGHT * VGA_WIDTH]u16 = undefined; // Save current screen when scrolling
